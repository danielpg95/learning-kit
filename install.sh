...
update_gitignore() {
...

  {
    printf "\n"
    echo "# --- learning-kit ---"
    echo ".claude/skills/learning-mode/"
    echo ".claude/skills/explain-code/"
    echo ".claude/skills/review-my-code/"
    echo ".claude/skills/concept-bridge/"
    echo ".claude/commands/why.md"
    echo ".claude/commands/teach.md"
    echo ".claude/commands/compare.md"
    echo ".claude/commands/review.md"
    echo ".claude/commands/checkpoint.md"
    echo ".claude/commands/evaluate.md"
    echo ".claude/.learning-kit-installed"
    echo "CLAUDE.md"
